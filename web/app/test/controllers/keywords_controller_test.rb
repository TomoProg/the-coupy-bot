...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post keywords_url, params: { keyword: { response_msg: @keyword.response_msg, send_msg: @keyword.send_msg } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { response_msg: @keyword.response_msg, send_msg: @keyword.send_msg } }
